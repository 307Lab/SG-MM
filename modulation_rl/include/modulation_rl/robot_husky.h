...
#ifndef MODULATION_RL_ROBOT_HUSKY_H
#define MODULATION_RL_ROBOT_HUSKY_H
...
typedef actionlib::SimpleActionClient<control_msgs::FollowJointTrajectoryAction> TrajClientHusky;
typedef boost::shared_ptr<TrajClientHusky> HuskyClientPtr;

class RobotHusky : public RobotEnv {
private:
    HuskyClientPtr arm_client_;
    // HuskyClientPtr torso_client_;
    HuskyClientPtr gripper_client_;
...
#endif  // MODULATION_RL_ROBOT_HUSKY_H
