...
#ifndef MODULATION_RL_ROBOT_SO101_H
#define MODULATION_RL_ROBOT_SO101_H
...
typedef actionlib::SimpleActionClient<control_msgs::FollowJointTrajectoryAction> TrajClientSO101;
typedef boost::shared_ptr<TrajClientSO101> SO101ClientPtr;

class RobotSO101 : public RobotEnv {
private:
    SO101ClientPtr arm_client_;
    // HuskyClientPtr torso_client_;
    SO101ClientPtr gripper_client_;
