...
PYBIND11_MODULE(pybindings_robots, m) {
    ...
    robotenv.def("reset", &RobotEnv::reset, "Reset.")
        ...
        .def("get_manipulability", &RobotEnv::get_manipulability, "get_manipulability.");
    ...
    py::class_<RobotHusky>(m, "RobotHusky", robotenv)
        .def(py::init<uint32_t, std::string, bool, std::string, RoboConf, double, double, double, std::string>());

    py::class_<RobotFg125>(m, "RobotFg125", robotenv)
        .def(py::init<uint32_t, std::string, bool, std::string, RoboConf, double, double, double, std::string>());
    
    py::class_<RobotSO101>(m, "RobotSO101", robotenv)
        .def(py::init<uint32_t, std::string, bool, std::string, RoboConf, double, double, double, std::string>());
