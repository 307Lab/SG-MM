...
def get_world_file(task, algo):
    ...
    if task in ["rndstartrndgoal", "restrictedws", "simpleobstacle", "spline"]:
        ...
        return "/home/cbl/mm_ws/src/modulation_rl/gazebo_world/worlds/modulation_tasks.world"
    elif task in ["dynobstacle"]:
        return "/home/cbl/mm_ws/src/modulation_rl/gazebo_world/worlds/dynamic_world.world"
        ...
        return "/home/cbl/mm_ws/src/modulation_rl/gazebo_world/worlds/bookstore.world"
